...
Short Description of Your Project and Objectives: We are utilizing a dataset from an Iranian telecom company to develop a model that predicts customer loss. Our objectives are to identify the key drivers of customer churn. Then we build the best predictive model to identify customers who are at risk of leaving. Finally, provide recommendations to help reduce customer loss. 
